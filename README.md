...
| [FileInsight](https://downloadcenter.trellix.com/products/mcafee-avert/fileinsight.msi) | `bookmarks` `calculator` `data-inspector` `executable-aware` `multi-file` `plugins` `scripting` `templates`                 | 🪟       | GUI       | Freeware     | 🇺🇸     | ~2006     | 🧊     |
...
| [Helium Hex Editor](http://jacquelin.potier.free.fr/HeliumHexEditor/)                   | `bookmarks` `diffing` `disassembly` `executable-aware` `multi-file` `plugins` `templates`                                   | 🪟       | GUI       | Commercial   | 🇫🇷     | 2015      | 🚀     |
...
| [Hexplorer](https://artemis.wszib.edu.pl/~mdudek/)                                      | `bookmarks` `data-inspector` `disassembly` `macros` `templates`                                                             | 🪟       | GUI       | GPL-2.0      | 🇵🇱     | 2002      | 🧊     |
...
| [ImHex](https://imhex.werwolv.net)                                                      | `bookmarks` `calculator` `comments` `data-inspector` `diffing` `disassembly` `multi-file` `plugins` `templates` `themes`    | 🪟🐧🍎   | GUI       | GPL-2.0      | 🇨🇭     | Nov 2020  | 🚀     |
| [Okteta](https://invent.kde.org/utilities/okteta)                                       | `bookmarks` `data-inspector` `multi-file` `plugins` `scripting` `templates` `themes`                                        | 🐧       | GUI       | GPL-3.0      | 🇩🇪     | 2003      | 🚀     |
| [rehex](https://github.com/solemnwarning/rehex)                                         | `comments` `data-inspector` `disassembly` `multi-file` `templates` `themes`                                                 | 🪟🐧🍎   | GUI       | GPL-3.0      | 🇬🇧     | Mar 2020  | 🚀     |
...
| `templates`        | Binary patterns/structures/templates                                            |
